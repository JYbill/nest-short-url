...
export async function bootstrap() {
  ...
  // 全局校验器
  app.useGlobalPipes(new ValidationPipe({ transform: false, skipMissingProperties: true }));
  ...
  // 开放静态文件
  app.useStaticAssets(join(__dirname, 'public/favicon.ico'), { prefix: '/favicon.ico' });
